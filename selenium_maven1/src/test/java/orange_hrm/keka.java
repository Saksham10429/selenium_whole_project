...
public class keka {
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		wb.findElement(By.xpath("//*[@class='whsOnd zHQkBf']")).sendKeys("Santosh@3155");
		Thread.sleep(4000);
		wb.findElement(By.xpath("//*[@class='VfPpkd-vQzf8d']")).click();
		Thread.sleep(15000);
		wb.findElement(By.xpath("//*[@class='btn btn-x-sm mx-4 btn-white']")).click();
		wb.findElement(By.xpath("//*[@class='btn btn-danger btn-x-sm']")).click();
		Thread.sleep(5000);
		wb.findElement(By.xpath("//*[@class='btn btn-danger btn-x-sm mr-10']")).click();
		Thread.sleep(2000);
		wb.close();
		}
	}
